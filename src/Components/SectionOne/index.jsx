...
export default function SectionOne() {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="container mx-auto px-4 sm:px-8 py-5 grid grid-cols-1 md:grid-cols-2 gap-2 items-center text-center md:text-left"
    >
      <div>
      ...
      <motion.img
        ...
        className="rounded-3xl shadow-xl w-full max-w-xs sm:max-w-sm md:w-[70%] mx-auto"
